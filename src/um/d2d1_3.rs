...
STRUCT!{#[debug] struct D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES {
...
STRUCT!{#[debug] struct D2D1_INK_POINT {
    x: FLOAT,
    y: FLOAT,
    radius: FLOAT,
}}
STRUCT!{#[debug] struct D2D1_INK_BEZIER_SEGMENT {
    point1: D2D1_INK_POINT,
    point2: D2D1_INK_POINT,
    point3: D2D1_INK_POINT,
}}
STRUCT!{#[debug] struct D2D1_INK_STYLE_PROPERTIES {
...
STRUCT!{#[debug] struct D2D1_GRADIENT_MESH_PATCH {
...
STRUCT!{#[debug] struct D2D1_SIMPLE_COLOR_PROFILE {
