...
STRUCT!{#[debug] struct D2D1_BITMAP_PROPERTIES {
    pixelFormat: D2D1_PIXEL_FORMAT,
    dpiX: FLOAT,
    dpiY: FLOAT,
}}
STRUCT!{#[debug] struct D2D1_GRADIENT_STOP {
    position: FLOAT,
    color: D2D1_COLOR_F,
}}
STRUCT!{#[debug] struct D2D1_BRUSH_PROPERTIES {
    opacity: FLOAT,
    transform: D2D1_MATRIX_3X2_F,
}}
STRUCT!{#[debug] struct D2D1_BITMAP_BRUSH_PROPERTIES {
    extendModeX: D2D1_EXTEND_MODE,
    extendModeY: D2D1_EXTEND_MODE,
    interpolationMode: D2D1_BITMAP_INTERPOLATION_MODE,
}}
STRUCT!{#[debug] struct D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES {
    startPoint: D2D1_POINT_2F,
    endPoint: D2D1_POINT_2F,
}}
STRUCT!{#[debug] struct D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES {
...
STRUCT!{#[debug] struct D2D1_BEZIER_SEGMENT {
    point1: D2D1_POINT_2F,
    point2: D2D1_POINT_2F,
    point3: D2D1_POINT_2F,
}}
STRUCT!{#[debug] struct D2D1_TRIANGLE {
    point1: D2D1_POINT_2F,
    point2: D2D1_POINT_2F,
    point3: D2D1_POINT_2F,
}}
...
STRUCT!{#[debug] struct D2D1_ARC_SEGMENT {
    point: D2D1_POINT_2F,
    size: D2D1_SIZE_F,
    rotationAngle: FLOAT,
...
STRUCT!{#[debug] struct D2D1_QUADRATIC_BEZIER_SEGMENT {
    point1: D2D1_POINT_2F,
    point2: D2D1_POINT_2F,
}}
STRUCT!{#[debug] struct D2D1_ELLIPSE {
    point: D2D1_POINT_2F,
    radiusX: FLOAT,
    radiusY: FLOAT,
}}
STRUCT!{#[debug] struct D2D1_ROUNDED_RECT {
    rect: D2D1_RECT_F,
    radiusX: FLOAT,
    radiusY: FLOAT,
}}
STRUCT!{#[debug] struct D2D1_STROKE_STYLE_PROPERTIES {
...
STRUCT!{#[debug] struct D2D1_LAYER_PARAMETERS {
...
STRUCT!{#[debug] struct D2D1_RENDER_TARGET_PROPERTIES {
...
STRUCT!{#[debug] struct D2D1_HWND_RENDER_TARGET_PROPERTIES {
    hwnd: HWND,
...
STRUCT!{#[debug] struct D2D1_DRAWING_STATE_DESCRIPTION {
...
STRUCT!{#[debug] struct D2D1_FACTORY_OPTIONS {
